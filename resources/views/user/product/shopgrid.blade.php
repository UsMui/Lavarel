            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-7">
                                ...
                                <div class="col-lg-4">
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__text">
                                            <span>{{$ps->name}}</span>
                                            <h5><a href="{{url("detail",["product"=>$ps->id])}}">{{$ps->name}}</a></h5>
                                            <div class="product__item__price">{{$ps->price*0.8}} <span>{{$ps->price}}</span></div>
                                        </div>
                                    </div>
                                </div>
                                @endforeach
                    ...
                    <div class="filter__item">
                        <form action="{{url("user/product/shopgrid")}}" method="get">
                        <div class="row">
                            <div class="col-md-3">
